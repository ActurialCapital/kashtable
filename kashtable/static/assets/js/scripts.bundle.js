...
var KTLayoutSidebar = function () {
    ...
    return {
        init: function (id) {
            ...
            _init();
            _initNav();
            _initContent('kt_sidebar_tab_0');
            _initContent('kt_sidebar_tab_1');
            _initContent('kt_sidebar_tab_2');
            _initContent('kt_sidebar_tab_3');
            _initContent('kt_sidebar_tab_4');
            _initContent('kt_sidebar_tab_5');
            _initContent('kt_sidebar_tab_6');
            _initContent('kt_sidebar_tab_7');
            _initContent('kt_sidebar_tab_8');
            _initContent('kt_sidebar_tab_9');
        },
